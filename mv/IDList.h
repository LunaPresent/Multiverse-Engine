...
namespace mv
{
	...
	/**
		...
		this container is optimised for insertion, random access and iteration,
		but sacrifices some performance when erasing random elements

		note that when iterating over this container the elements will be in the order
